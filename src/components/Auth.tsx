...
export function Auth() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-yellow-50 to-purple-50">
      {/* Header */}
          ...
          <div className="space-y-8">
            ...
            <div className="flex justify-center lg:justify-start">
              <div className="bg-yellow-100 rounded-full px-4 py-2 flex items-center space-x-2">
                ...
                <span className="text-sm font-medium text-yellow-700">Trusted by 50,000+ college students</span>
              </div>
            </div>
            ...
            <div id="reviews" className="space-y-6">
              <div className="text-center lg:text-left">
                <h2 className="text-3xl font-bold text-gray-900 mb-2">Loved by Students Everywhere</h2>
                <p className="text-gray-600">See what college students are saying about Finly.</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {testimonials.map((testimonial, index) => (
                  <div key={index} className={`${testimonial.bgColor} rounded-xl p-6`}>
                    ...
                    <div className="flex items-center space-x-3">
                      <div className={`w-10 h-10 rounded-full ${testimonial.bgColor === 'bg-blue-50' ? 'bg-blue-200' : 'bg-yellow-200'} flex items-center justify-center`}>
